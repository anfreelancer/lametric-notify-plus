package com.luteapp.lametricnotify;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeView(String search, boolean firstRun) {
        ...
        if (firstRun) {
            ...
            final Button btnPremium = (Button) findViewById(R.id.btnPremium);
        ...
        recyclerView.setAdapter(new AppAdapter(this, appList, search));
    }
